	...
	return (
		<article className="bg-secondary">
			<section className="wrapper">
				<article className="h-15 flex justify-between items-center gap-2">
					<Link className="flex items-center" to="/note">
						<TfiPencilAlt2 className=" fill-logo w-5 md:w-6 h-5 md:h-6"  />
						<h1 className="text-logo font-secondary text-lg md:text-2xl font-semibold">ClenchSnap</h1>
					</Link>
					<section className="ml-auto md:ml-0 flex items-center w-[40%] max-w-md h-6 md:h-7 bg-white rounded-xs overflow-hidden">
						<input
							className="w-[calc(100%-24px)] outline-0 px-3 py-1 text-xs md:text-sm"
							type="text"
							placeholder="Search..."
						/>
